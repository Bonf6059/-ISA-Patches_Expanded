...
<Defs>
	...
	<BodyDef>
		...
		<corePart>
			...
			<parts>
				...
				<li>
					<def>Flipper</def>
					<customLabel>front left flipper</customLabel>
					<coverage>0.1</coverage>
					<height>Bottom</height>
				</li>
				<li>
					<def>Flipper</def>
					<customLabel>front right flipper</customLabel>
					<coverage>0.1</coverage>
					<height>Bottom</height>
				</li>
				<li>
 ...
 <BodyDef>
    <defName>CentipedeLike</defName>
    <label>centipede-like</label>
    <corePart>
      <def>CentipedeFirstSegment</def>
      <height>Middle</height>
      <depth>Outside</depth>
      <parts>
        <li>
        ...
        <li>
          <def>CentipedeSecondSegment</def>
          <coverage>0.71</coverage>
          <parts>
            <li>
              <def>CentipedeThirdSegment</def>
              <coverage>0.8</coverage>
              <parts>
                <li>
                  <def>CentipedeFourthSegment</def>
                  <coverage>0.75</coverage>
                  <parts>
                    <li>
                      <def>CentipedeFifthSegment</def>
                      <coverage>0.66</coverage>
                      <parts>
                        <li>
                          <def>CentipedeSixthSegment</def>
	...
	<BodyDef>
		<defName>QuadrupedAnimalWithPawsTailAndFangs</defName>
	...
	<BodyDef>
		<defName>QuadrupedAnimalWithCarapace</defName>
		<label>quadruped animal with carapace</label>
		<corePart>
			<def>GlyptodonCarapace</def>
			<height>Middle</height>
			<depth>Outside</depth>
			<parts>
				<li>
					<def>GlyptodonShell</def>
					<coverage>0.2</coverage>
					<groups>
						<li>GlyptodonShellGroup</li>
					</groups>
				</li>
				<li>
					<def>Tail</def>
  ...
  <BodyDef>
    <defName>KangarooLike</defName>
    <label>kangaroo-like</label>
    <corePart>
	<def>Body</def>
	<height>Middle</height>
	<depth>Outside</depth>
  ...
  <BodyDef>
    <defName>FlyingInsect</defName>
    <label>flying insect</label>
    <corePart>
      <def>Shell</def>
      <height>Middle</height>
      <depth>Outside</depth>
          ...
          <parts>
            <li>
              ...
              <parts>
                ...
                <li>
                  <def>Eye</def>
                  <customLabel>left lateral eye</customLabel>
                  <coverage>0.15</coverage>
                </li>
                <li>
                  <def>Eye</def>
                  <customLabel>right lateral eye</customLabel>
                  <coverage>0.15</coverage>
                </li>
                <li>
                  <def>Eye</def>
                  <customLabel>left median eye</customLabel>
                  <coverage>0.10</coverage>
                </li>
                <li>
                  <def>Eye</def>
                  <customLabel>right median eye</customLabel>
                  <coverage>0.10</coverage>
                </li>
                <li>
                  <def>InsectNostril</def>
